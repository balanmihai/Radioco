...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    var webhookMiddleware, payload, preCheckoutRouter;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                preCheckoutRouter = express_1.default.Router();
                preCheckoutRouter.post("/pre-checkout", payload.authenticate, function (req, res) {
                    var request = req;
                    if (!request.user) {
